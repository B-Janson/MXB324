function f = V24(DIM, i, h, h_old, phi, phi_old, k, k_old, PARAMS)
...
f = phi(point) - phi_old(point) - dt/VOL * (theta * ( ...
            ...
            + (k(point) + k(north)) * K_zz * D(2) / 4 * ((h(north) - h(point)) / D(4) + 1)  ... % gamma 2
            + (k(point) + k(north)) * K_zz * D(1) / 4 * ((h(north) - h(point)) / D(4) + 1)  ... % gamma 3
            + (k(point) + k(west)) * K_xx * D(4)/(4 * D(1)) * (h(west) - h(point)) ... % gamma 4
            + (k(point) + k(west)) * K_xx * D(3)/(4 * D(1)) * (h(west) - h(point)) ... % gamma 5
            + (k(point) + k(south)) * K_zz * D(1) / 4 * ((h(south) - h(point)) / D(3) - 1)  ... % gamma 6
            + (k(point) + k(south)) * K_zz * D(2) / 4 * ((h(south) - h(point)) / D(3) - 1)  ... % gamma 7
            ...
            + (k_old(point) + k_old(north)) * K_zz * D(1) / 4 * ((h_old(north) - h_old(point)) / D(4) + 1)  ... % gamma 3
            ...
            + (k_old(point) + k_old(south)) * K_zz * D(1) / 4 * ((h_old(south) - h_old(point)) / D(3) - 1)  ... % gamma 6

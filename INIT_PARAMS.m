...
PARAMS.r_f = 0.0171;         % rainfall constant
PARAMS.dt = 0.5;        % timestep size
PARAMS.endtime = 2000;   % end time
...
PARAMS.max_iters = 100; % maximum number of iterations for the Newton step
